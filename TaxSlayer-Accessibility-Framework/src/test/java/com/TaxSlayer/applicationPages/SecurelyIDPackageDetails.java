...
public class SecurelyIDPackageDetails extends BaseClass {
	...
	public void SecurelyIDMethod() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(SecurelyIDLocators.Continuebtn)));

		WebElement element2 = driver.findElement(By.cssSelector(SecurelyIDLocators.Continuebtn));

		JavascriptExecutor executor2 = (JavascriptExecutor) driver;

		executor2.executeScript("arguments[0].click();", element2);

		System.out.println("Continue button works");
