...
import com.TaxSlayer.applicationPages.ViewDetailsPage;
...
public class ViewDetailsExecution extends BaseClass {

	@Parameters({ "QAENVURL" })
	@Test
	public void ViewDetailsExecutionMethod(String QAENVURL) throws InterruptedException, IOException
...
//			welcomepgobj.welcomepageTestmethod();
			...
			ArrayList<String> creds = readobj.ReadExcelLoginMethod("federal return accepted");
			...
			ViewDetailsPage viewDetailsobj = new ViewDetailsPage();

			viewDetailsobj.ViewDetailsMethod();

			AxeCoreImplmnClass logaxecoreobj = new AxeCoreImplmnClass();

			logaxecoreobj.AxeCoreImplmnmethod(pageNameVariables.viewDetailspage);

			GetExistingworkitemsPOSTAPI getworkitemobj = new GetExistingworkitemsPOSTAPI();

			getworkitemobj.ProcessADO(pageNameVariables.viewDetailspage);

			GetDetailsPOSTAPI getDetailsobj = new GetDetailsPOSTAPI();

			getDetailsobj.GetDetails();

			CompareWorkItemsinADO compworkitems = new CompareWorkItemsinADO(pageNameVariables.viewDetailspage);
			...
			System.out.println("View Details Execution has ended successfully");
