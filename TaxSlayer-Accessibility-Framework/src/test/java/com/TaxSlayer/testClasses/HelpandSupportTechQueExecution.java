...
import com.TaxSlayer.applicationPages.HelpandSupportTechQPage;
...
public class HelpandSupportTechQueExecution extends BaseClass {
...
//			welcomepgobj.welcomepageTestmethod();
			...
			HelpandSupportTechQPage helpsupptechobj = new HelpandSupportTechQPage();

			helpsupptechobj.HelpandSupportTechQMethod();

			AxeCoreImplmnClass logaxecoreobj = new AxeCoreImplmnClass();

			logaxecoreobj.AxeCoreImplmnmethod(pageNameVariables.helpandsupptechqpage);

			GetExistingworkitemsPOSTAPI getworkitemobj = new GetExistingworkitemsPOSTAPI();

			getworkitemobj.ProcessADO(pageNameVariables.helpandsupptechqpage);

			GetDetailsPOSTAPI getDetailsobj = new GetDetailsPOSTAPI();

			getDetailsobj.GetDetails();

			CompareWorkItemsinADO compworkitems = new CompareWorkItemsinADO(pageNameVariables.helpandsupptechqpage);
